...
namespace loggalApi.Controllers
{
    public class AdvertisingController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public IList<AD_LIST> GetAdList([FromBody]AD_SEARCH_COND Cond)
        {
            IList<AD_LIST> list = new CategoryService().GetAdList(Cond);
            return list;
        }
        ...
        /// <returns></returns>
        [HttpGet]
        public IList<AD_LIST> GetAdList2([FromUri]AD_SEARCH_COND Cond)
        {
            IList<AD_LIST> list = new CategoryService().GetAdList(Cond);
