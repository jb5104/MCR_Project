...
namespace MRC.Framework.Data
{
    public class Koreanunit
    {
        ...
        public struct HANGUL_INFO
        {
            ...
            public List<string> arrChosung { get { return chosung.Split(' ').ToList(); } set { } }
            public List<string> arrJungung { get { return jungsung.Split(' ').ToList(); } set { } }
            public List<string> arrJongung { get { return jongsung.Split(' ').ToList(); } set { } }
